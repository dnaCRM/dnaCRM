...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <!-- Testando como ficaria os itens mostrada na tela inicial -->

        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">Ultimas Ordens de Serviço</h3></div>
        ...
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h3 class="panel-title">Ultimas Ocorrências</h3></div>
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">Ultimos Perfil Cadastrado</h3></div>
        ...
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h3 class="panel-title">Ultimos Perfil Atualizados</h3></div>
    ...
    <!-- Fim do teste de layout de pagina inicial -->
