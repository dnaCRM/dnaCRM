...
<ul class="nav nav-tabs">
    <li class="active"><a href="#principal" data-toggle="tab">Dados Condominio</a></li>
</ul>
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <div class="col-md-8">
                ...
                <p>Informação cadastrada
                    <strong><?php echo $cadastrado->getNmCondominio(); ?></strong>?
                </p>
                ...
                <a href="Condominio/formcondominio/<?php echo $cadastrado->getCdCondominio(); ?>"
...
<?php else: ?>
    ...
    <div class="col-md-2">
        ...
        <img class="img-circle img-responsive" src="<?php echo $condominio->getImPerfil(); ?>"><br>
