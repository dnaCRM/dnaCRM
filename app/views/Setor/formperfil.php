 ...
 <div class="form-group">
    <div class="col-sm-12 inputGroupContainer">
        ...
        <input type="text" class="form-control" id="nm_setor" name="nm_setor"
             value="<?php echo $perfil->getNmSetor() == '' ? Input::get('nm_setor') : $perfil->getNmSetor(); ?>"
             placeholder="Nome">
    </div>
 </div>
...
<div class="form-group">
    <div class="col-sm-12 selectContainer">
        ...
        <select class="form-control" id="cd_cgc" name="cd_condominio">
            ...
            $perfil->setCdCondominio($perfil->getCdCondominio() == '' ? Input::get('cd_condominio') : $perfil->getCdCondominio());
            foreach ($data['condominio'] as $condominio) {

                if ($condominio->getCdCondominio() == $perfil->getCdCondominio()) {
...
<div class="form-group">
     <div class="col-sm-12 selectContainer">
         <label for="cd_condominio" class="control-label">Observação</label>
...
<div class="form-group ">
    <div class="col-sm-12">
        ...
        <a href="Setor/formperfil" id="novo" class="btn btn-success"><span class="fa fa-file"></span>
            Novo</a>
