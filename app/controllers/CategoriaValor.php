...
class CategoriaValor extends Controller
{
    ...
    private function setDados()
    {
        ...
        $dto
            ...
            ->setGenero(Input::get('genero') == '' ? null : Input::get('genero'))
            ->setCdGrupo(Input::get('cd_grupo') == '' ? null : Input::get('cd_grupo'))
            ->setCdCatGrupo(Input::get('cd_cat_grupo') == '' ? null : Input::get('cd_cat_grupo'))
