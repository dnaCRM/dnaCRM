...
CREATE TABLE TB_APARTAMENTO(
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_APARTAMENTO_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_APARTAMENTO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_APARTAMENTO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_APARTAMENTO_DT_USUARIO_ATUALIZA NOT NULL,   
...
CREATE TABLE TB_CATEGORIA(
  ...
  DT_USUARIO_CRIACAO DATE,   
  CD_USUARIO_ATUALIZA INTEGER,
  DT_USUARIO_ATUALIZA DATE,  
...
CREATE TABLE TB_CONDOMINIO(
  ...
  ESTADO VARCHAR(25) CONSTRAINT NN_TB_CONDOMINIO_ESTADO NOT NULL,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_CONDOMINIO_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_CONDOMINIO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_CONDOMINIO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_CONDOMINIO_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_ITENS_ORCAMENTO(
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_ITENS_ORCAMENTO_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_ITENS_ORCAMENTO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_ITENS_ORCAMENTO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_ITENS_ORCAMENTO_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_MORADOR_ENDERECO(
  ...
  DT_ENTRADA DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_DT_ENTRADA NOT NULL,
  DT_SAIDA DATE,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_MORADOR_ENDERECO_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_MORADOR_ENDERECO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_OCORRENCIA_PF_ENVOLVIDA(
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_OCORRENCIA(
  ...
  DT_OCORRENCIA DATE CONSTRAINT NN_TB_OCORRENCIA_DT_OCORRENCIA NOT NULL,
  IE_SITUACAO CHAR(1) CONSTRAINT NN_TB_OCORRENCIA_IE_SITUACAO NOT NULL,
  DT_FIM DATE,
  DESC_CONCLUSAO TEXT,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_OCORRENCIA_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_OCORRENCIA_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_OCORRENCIA_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_OCORRENCIA_DT_USUARIO_ATUALIZA NOT NULL, 
  CONSTRAINT PK_TB_OCORRENCIA_CD_OCORRENICA PRIMARY KEY(CD_OCORRENCIA)
);

CREATE TABLE TB_ORCAMENTO(
  CD_ORCAMENTO SERIAL,
  CD_ORDEM_SERVICO INTEGER CONSTRAINT NN_TB_ORCAMENTO_CD_ORDEM_SERVICO NOT NULL,
  DT_ORCAMENTO DATE CONSTRAINT NN_TB_ORCAMENTO_DT_ORCAMENTO NOT NULL,
  DT_FIM DATE,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_ORCAMENTO_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_ORCAMENTO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_ORCAMENTO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_ORCAMENTO_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_ORDEM_SERVICO(
  ...
  CD_PF_EXECUTOR INTEGER CONSTRAINT NN_TB_ORDEM_SERVICO_CD_PF_EXECUTOR NOT NULL,
  ...
  DT_INICIO DATE CONSTRAINT NN_TB_ORDEM_SERVICO_DT_INICIO NOT NULL,
  DT_FIM DATE,
  ...
  DESC_CONCLUSAO TEXT,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_ORDEM_SERVICO_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_ORDEM_SERVICO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_ORDEM_SERVICO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_ORDEM_SERVICO_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PESSOA_JURIDICA(
  ...
  IM_PERFIL OID,  
  EMAIL VARCHAR(30), 
  FONE VARCHAR(13) CONSTRAINT NN_TB_PESSOA_JURIDICA_FONE NOT NULL,
  FONE_FAX VARCHAR(13),
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_PESSOA_JURIDICA_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PESSOA_JURIDICA_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PESSOA_JURIDICA_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PESSOA_JURIDICA_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PF_ENDERECO(
  ...
  CEP NUMERIC(8,0) CONSTRAINT NN_TB_PF_ENDERECO_CEP NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PF_ENDERECO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PF_ENDERECO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PF_ENDERECO_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PJ_ENDERECO(
  ...
  CEP NUMERIC(8,0) CONSTRAINT NN_TB_PJ_ENDERECO_CEP NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PJ_ENDERECO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PJ_ENDERECO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PJ_ENDERECO_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PROFISSAO(
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PROFISSAO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PROFISSAO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PROFISSAO_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_RELACIONADOS(
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_RELACIONADOS_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_RELACIONADOS_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_RELACIONADOS_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_SERVICO_ADICIONAL(
  ...
  CD_SETOR INTEGER,
  CD_VAGA INTEGER,
  DT_INICIO DATE CONSTRAINT NN_TB_SERVICO_ADICIIONAL_DT_INICIO NOT NULL,
  DT_FIM INTEGER,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_SERVICO_ADICIONAL_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_SERVICO_ADICIONAL_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_SERVICO_ADICIONAL_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_SERVICO_ADICIONAL_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_SETOR(
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_SETOR_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_SETOR_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_SETOR_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_USUARIO(
  CD_USUARIO SERIAL,
  CD_PESSOA_FISICA INTEGER CONSTRAINT NN_TB_USUARIO_CD_PESSOA_FISICA NOT NULL,
  LOGIN VARCHAR(20) CONSTRAINT NN_TB_USUARIO_LOGIN NOT NULL,
  SENHA VARCHAR(64) CONSTRAINT NN_TB_USUARIO_SENHA NOT NULL,
  SALT  VARCHAR(32) CONSTRAINT NN_TB_USUARIO_SALT NOT NULL,
...
DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_VAGA_GARAGEM_DT_USUARIO_CRIACAO NOT NULL,   
CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_VAGA_GARAGEM_CD_USUARIO_ATUALIZA NOT NULL,
DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_VAGA_GARAGEM_DT_USUARIO_ATUALIZA NOT NULL,
...
DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PF_TELEFONE_DT_USUARIO_CRIACAO NOT NULL,   
CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PF_TELEFONE_CD_USUARIO_ATUALIZA NOT NULL,
DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PF_TELEFONE_DT_USUARIO_ATUALIZA NOT NULL,
...
DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PJ_TELEFONE_DT_USUARIO_CRIACAO NOT NULL,   
CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PJ_TELEFONE_CD_USUARIO_ATUALIZA NOT NULL,
DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PJ_TELEFONE_DT_USUARIO_ATUALIZA NOT NULL,
...
DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_INSTITUICAO_ENSINO_DT_USUARIO_CRIACAO NOT NULL,   
CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_INSTITUICAO_ENSINO_CD_USUARIO_ATUALIZA NOT NULL,
DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_INSTITUICAO_ENSINO_DT_USUARIO_ATUALIZA NOT NULL,
...
ALTER TABLE TB_SERVICO_ADICIONAL ADD CONSTRAINT FK_TB_SERVICO_ADICIONAL_CD_PESSOA_FISICA FOREIGN KEY(CD_PESSOA_FISICA) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_SERVICO_ADICIONAL ADD CONSTRAINT FK_TB_SERVICO_ADICIONAL_CD_CATG_SERVICO_CD_CATG_VL_SERVICO FOREIGN KEY(CD_CATG_SERVICO,CD_CATG_VL_SERVICO) REFERENCES TB_CATEGORIA_VALOR(CD_CATEGORIA,CD_VL_CATEGORIA);

ALTER TABLE TB_PESSOA_FISICA ADD CONSTRAINT FK_TB_PESSOA_FISICA FOREIGN KEY(CD_INSTITUICAO) REFERENCES TB_INSTITUICAO_ENSINO(CD_INSTITUICAO);

ALTER TABLE TB_PJ_TELEFONE ADD CONSTRAINT FK_TB_PJ_TELEFONE FOREIGN KEY(CD_PESSOA_JURIDICA) REFERENCES TB_PESSOA_JURIDICA(CD_PESSOA_JURIDICA);

ALTER TABLE TB_PF_TELEFONE ADD CONSTRAINT FK_TB_PF_TELEFONE FOREIGN KEY(CD_PESSOA_FISICA) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_VAGA_GARAGEM ADD CONSTRAINT FK_TB_VAGA_GARAGEM_CD_SETOR FOREIGN KEY(CD_SETOR) REFERENCES TB_SETOR(CD_SETOR);

ALTER TABLE TB_USUARIO ADD CONSTRAINT FK_TB_USUARIO_CD_PESSOA_FISICA FOREIGN KEY(CD_PESSOA_FISICA) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_SETOR ADD CONSTRAINT FK_TB_SETOR_CD_CONDOMINIO FOREIGN KEY(CD_CONDOMINIO) REFERENCES TB_CONDOMINIO(CD_CONDOMINIO);

ALTER TABLE TB_SERVICO_ADICIONAL ADD CONSTRAINT FK_TB_SERVICO_ADICIONAL_CD_ORDEM_SERVICO FOREIGN KEY(CD_ORDEM_SERVICO) REFERENCES TB_ORDEM_SERVICO(CD_ORDEM_SERVICO);

ALTER TABLE TB_RELACIONADOS ADD CONSTRAINT FK_TB_RELACIONADOS_CD_PESSOA_FISICA_1 FOREIGN KEY(CD_PESSOA_FISICA_1) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_RELACIONADOS ADD CONSTRAINT FK_TB_RELACIONADOS_CD_PESSOA_FISICA_2 FOREIGN KEY(CD_PESSOA_FISICA_2) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_PJ_ENDERECO ADD CONSTRAINT FK_TB_PJ_ENDERECO_CD_PESSOA_JURIDICA FOREIGN KEY(CD_PESSOA_JURIDICA) REFERENCES TB_PESSOA_JURIDICA(CD_PESSOA_JURIDICA);

ALTER TABLE TB_PJ_ENDERECO ADD CONSTRAINT FK_TB_PJ_ENDERECO_CD_CATG_END FOREIGN KEY(CD_CATG_END) REFERENCES TB_CATEGORIA(CD_CATEGORIA);

ALTER TABLE TB_PJ_ENDERECO ADD CONSTRAINT FK_TB_PJ_ENDERECO_CD_CATG_END_CD_VL_CATG_END FOREIGN KEY(CD_CATG_END,CD_VL_CATG_END) REFERENCES TB_CATEGORIA_VALOR(CD_CATEGORIA,CD_VL_CATEGORIA);

ALTER TABLE TB_PF_ENDERECO ADD CONSTRAINT FK_TB_PF_ENDERECO_CD_PESSOA_FISICA FOREIGN KEY(CD_PESSOA_FISICA) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_PF_ENDERECO ADD CONSTRAINT FK_TB_PF_ENDERECO_CD_CATG_END_CD_VL_CATG_END FOREIGN KEY(CD_CATG_END,CD_VL_CATG_END) REFERENCES TB_CATEGORIA_VALOR(CD_CATEGORIA,CD_VL_CATEGORIA);

ALTER TABLE TB_PESSOA_FISICA ADD CONSTRAINT FK_TB_PESSOA_FISICA_CD_PESSOA_JURIDICA FOREIGN KEY(CD_PESSOA_JURIDICA) REFERENCES TB_PESSOA_JURIDICA(CD_PESSOA_JURIDICA);

ALTER TABLE TB_PESSOA_FISICA ADD CONSTRAINT FK_TB_PESSOA_FISICA_CD_PROFISSAO FOREIGN KEY(CD_PROFISSAO) REFERENCES TB_PROFISSAO(CD_PROFISSAO);

ALTER TABLE TB_ORDEM_SERVICO ADD CONSTRAINT FK_TB_ORDEM_SERVICO_CD_OCORRENCIA FOREIGN KEY(CD_OCORRENCIA) REFERENCES TB_OCORRENCIA(CD_OCORRENCIA);

ALTER TABLE TB_ORDEM_SERVICO ADD CONSTRAINT FK_TB_ORDEM_SERVICO_CD_PF_EXECUTOR FOREIGN KEY(CD_PF_EXECUTOR) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_ORDEM_SERVICO ADD CONSTRAINT FK_TB_PESSOA_FISICA_CD_PF_SOLICITANTE FOREIGN KEY(CD_PF_SOLICITANTE) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_ORCAMENTO ADD CONSTRAINT FK_TB_ORCAMENTO_CD_ORDEM_SERVICO FOREIGN KEY(CD_ORDEM_SERVICO) REFERENCES TB_ORDEM_SERVICO(CD_ORDEM_SERVICO);

ALTER TABLE TB_OCORRENCIA ADD CONSTRAINT FK_TB_OCORRENCIA_CD_PF_INFORMANTE FOREIGN KEY(CD_PF_INFORMANTE) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_OCORRENCIA_PF_ENVOLVIDA ADD CONSTRAINT FK_TB_OCORRENCIA_PF_ENVOLVIDA_CD_PESSOA_FISICA FOREIGN KEY(CD_PESSOA_FISICA) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_OCORRENCIA_PF_ENVOLVIDA ADD CONSTRAINT FK_TB_OCORRENCIA_PF_ENVOLVIDA_CD_OCORRENCIA FOREIGN KEY(CD_OCORRENCIA) REFERENCES TB_OCORRENCIA(CD_OCORRENCIA);

ALTER TABLE TB_MORADOR_ENDERECO ADD CONSTRAINT FK_TB_MORADOR_ENDERECO_CD_PESSOA_FISICA FOREIGN KEY(CD_PESSOA_FISICA) REFERENCES TB_PESSOA_FISICA(CD_PESSOA_FISICA);

ALTER TABLE TB_MORADOR_ENDERECO ADD CONSTRAINT FK_TB_MORADOR_ENDERECO_CD_APARTAMENTO FOREIGN KEY(CD_APARTAMENTO) REFERENCES TB_APARTAMENTO(CD_APARTAMENTO);

ALTER TABLE TB_ITENS_ORCAMENTO ADD CONSTRAINT FK_TB_ITENS_ORCAMENTO_CD_PESSOA_JURIDICA FOREIGN KEY(CD_PESSOA_JURIDICA) REFERENCES TB_PESSOA_JURIDICA(CD_PESSOA_JURIDICA);

ALTER TABLE TB_ITENS_ORCAMENTO ADD CONSTRAINT FK_TB_ITENS_ORCAMENTO_CD_ORCAMENTO FOREIGN KEY(CD_ORCAMENTO) REFERENCES TB_ORCAMENTO(CD_ORCAMENTO);

ALTER TABLE TB_CATEGORIA_VALOR ADD CONSTRAINT FK_TB_CATEGORIA_VALOR_CD_CATEGORIA FOREIGN KEY(CD_CATEGORIA) REFERENCES TB_CATEGORIA(CD_CATEGORIA);

ALTER TABLE TB_APARTAMENTO ADD CONSTRAINT FK_TB_APARTAMENTO_CD_SETOR FOREIGN KEY(CD_SETOR) REFERENCES TB_SETOR(CD_SETOR);

ALTER TABLE TB_USUARIO ADD CONSTRAINT FK_TB_USUARIO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_USUARIO ADD CONSTRAINT FK_TB_USUARIO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_SETOR ADD CONSTRAINT FK_TB_SETOR_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_SETOR ADD CONSTRAINT FK_TB_SETOR_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_SERVICO_ADICIONAL ADD CONSTRAINT FK_TB_SERVICO_ADICIONAL_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_SERVICO_ADICIONAL ADD CONSTRAINT FK_TB_SERVICO_ADICIONAL_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_RELACIONADOS ADD CONSTRAINT FK_TB_RELACIONADOS_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_RELACIONADOS ADD CONSTRAINT FK_TB_RELACIONADOS_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PROFISSAO ADD CONSTRAINT FK_TB_PROFISSAO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PROFISSAO ADD CONSTRAINT FK_TB_PROFISSAO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PJ_ENDERECO ADD CONSTRAINT FK_TB_PJ_ENDERECO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PJ_ENDERECO ADD CONSTRAINT FK_TB_PJ_ENDERECO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PF_ENDERECO ADD CONSTRAINT FK_TB_PF_ENDERECO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PF_ENDERECO ADD CONSTRAINT FK_TB_PF_ENDERECO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PESSOA_JURIDICA ADD CONSTRAINT FK_TB_PESSOA_JURIDICA_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PESSOA_JURIDICA ADD CONSTRAINT FK_TB_PESSOA_JURIDICA_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PESSOA_FISICA ADD CONSTRAINT FK_TB_PESSOA_FISICA_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PESSOA_FISICA ADD CONSTRAINT FK_TB_PESSOA_FISICA_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ORDEM_SERVICO ADD CONSTRAINT FK_TB_ORDEM_SERVICO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ORDEM_SERVICO ADD CONSTRAINT FK_TB_ORDEM_SERVICO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ORCAMENTO ADD CONSTRAINT FK_TB_ORCAMENTO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ORCAMENTO ADD CONSTRAINT FK_TB_ORCAMENTO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_OCORRENCIA ADD CONSTRAINT FK_TB_OCORRENCIA_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_OCORRENCIA ADD CONSTRAINT FK_TB_OCORRENCIA_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_OCORRENCIA_PF_ENVOLVIDA ADD CONSTRAINT FK_TB_OCORRENCIA_PF_ENVOLVIDA_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_OCORRENCIA_PF_ENVOLVIDA ADD CONSTRAINT FK_TB_OCORRENCIA_PF_ENVOLVIDA_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_MORADOR_ENDERECO ADD CONSTRAINT FK_TB_MORADOR_ENDERECO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_MORADOR_ENDERECO ADD CONSTRAINT FK_TB_MORADOR_ENDERECO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ITENS_ORCAMENTO ADD CONSTRAINT FK_TB_ITENS_ORCAMENTO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ITENS_ORCAMENTO ADD CONSTRAINT FK_TB_ITENS_ORCAMENTO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CONDOMINIO ADD CONSTRAINT FK_TB_CONDOMINIO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CONDOMINIO ADD CONSTRAINT FK_TB_CONDOMINIO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CATEGORIA_VALOR ADD CONSTRAINT FK_TB_CATEGORIA_VALOR_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CATEGORIA_VALOR ADD CONSTRAINT FK_TB_CATEGORIA_VALOR_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CATEGORIA ADD CONSTRAINT FK_TB_CATEGORIA_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CATEGORIA ADD CONSTRAINT FK_TB_CATEGORIA_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_APARTAMENTO ADD CONSTRAINT FK_TB_APARTAMENTO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_APARTAMENTO ADD CONSTRAINT FK_TB_APARTAMENTO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_VAGA_GARAGEM ADD CONSTRAINT FK_TB_VAGA_GARAGEM_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_VAGA_GARAGEM ADD CONSTRAINT FK_TB_VAGA_GARAGEM_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PF_TELEFONE ADD CONSTRAINT FK_TB_PF_TELEFONE_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PF_TELEFONE ADD CONSTRAINT FK_TB_PF_TELEFONE_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PJ_TELEFONE ADD CONSTRAINT FK_TB_PJ_TELEFONE_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PJ_TELEFONE ADD CONSTRAINT FK_TB_PJ_TELEFONE_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_INSTITUICAO_ENSINO ADD CONSTRAINT FK_TB_INSTITUICAO_ENSINO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_INSTITUICAO_ENSINO ADD CONSTRAINT FK_TB_INSTITUICAO_ENSINO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);
...
CREATE TABLE TB_APARTAMENTO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_APARTAMENTO_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_APARTAMENTO_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_APARTAMENTO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_APARTAMENTO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_APARTAMENTO_LOG_DT_USUARIO_ATUALIZA NOT NULL,   
...
CREATE TABLE TB_CATEGORIA_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_CATEGORIA_LOG_DT_EXECUTOR NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_CATEGORIA_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_CATEGORIA_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_CATEGORIA_LOG_DT_USUARIO_ATUALIZA NOT NULL,  
...
CREATE TABLE TB_CATEGORIA_VALOR_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_CATEGORIA_VALOR_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_CATEGORIA_VALOR_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_CATEGORIA_VALOR_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_CATEGORIA_VALOR_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_CATEGORIA_VALOR_LOG_DT_USUARIO_ATUALIZA NOT NULL,  
...
CREATE TABLE TB_CONDOMINIO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_CONDOMINIO_LOG_DT_EXECUTOR NOT NULL,
  ...
  ESTADO VARCHAR(25) CONSTRAINT NN_TB_CONDOMINIO_LOG_ESTADO NOT NULL,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_CONDOMINIO_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_CONDOMINIO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_CONDOMINIO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_CONDOMINIO_LOG_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_ITENS_ORCAMENTO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_ITENS_ORCAMENTO_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_ITENS_ORCAMENTO_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_ITENS_ORCAMENTO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_ITENS_ORCAMENTO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_ITENS_ORCAMENTO_LOG_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_MORADOR_ENDERECO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_LOG_DT_EXECUTOR NOT NULL,
  ...
  DT_ENTRADA DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_LOG_DT_ENTRADA NOT NULL,
  DT_SAIDA DATE,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_MORADOR_ENDERECO_LOG_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_MORADOR_ENDERECO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_MORADOR_ENDERECO_LOG_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_OCORRENCIA_PF_ENVOLVIDA_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_OCORRENCIA_PF_ENVOLVIDA_LOG_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_OCORRENCIA_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_OCORRENCIA_LOG_DT_EXECUTOR NOT NULL,
  ...
  DT_OCORRENCIA DATE CONSTRAINT NN_TB_OCORRENCIA_LOG_DT_OCORRENCIA NOT NULL,
  IE_SITUACAO CHAR(1) CONSTRAINT NN_TB_OCORRENCIA_LOG_IE_SITUACAO NOT NULL,
  DT_FIM DATE,
  DESC_CONCLUSAO TEXT,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_OCORRENCIA_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_OCORRENCIA_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_OCORRENCIA_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_OCORRENCIA_LOG_DT_USUARIO_ATUALIZA NOT NULL, 
...
CREATE TABLE TB_ORCAMENTO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_ORCAMENTO_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_ORDEM_SERVICO INTEGER CONSTRAINT NN_TB_ORCAMENTO_LOG_CD_ORDEM_SERVICO NOT NULL,
  DT_ORCAMENTO DATE CONSTRAINT NN_TB_ORCAMENTO_LOG_DT_ORCAMENTO NOT NULL,
  DT_FIM DATE,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_ORCAMENTO_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_ORCAMENTO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_ORCAMENTO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_ORCAMENTO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_ORDEM_SERVICO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_PF_EXECUTOR INTEGER CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_CD_PF_EXECUTOR NOT NULL,
  ...
  DT_INICIO DATE CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_DT_INICIO NOT NULL,
  DT_FIM DATE,
  ...
  DESC_CONCLUSAO TEXT,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_CD_USUARIO_CRIACAONOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_ORDEM_SERVICO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PESSOA_FISICA_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_PESSOA_FISICA_LOG_DT_EXECUTOR NOT NULL,
  ...
  EMAIL VARCHAR(60),  
  FONE VARCHAR(13) CONSTRAINT NN_TB_PESSOA_FISICA_LOG_FONE NOT NULL,  
  CELULAR VARCHAR(14),
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PESSOA_FISICA_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PESSOA_FISICA_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PESSOA_FISICA_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PESSOA_JURIDICA_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_PESSOA_JURIDICA_LOG_DT_EXECUTOR NOT NULL,
  ...
  DESC_ATIVIDADE TEXT,
  EMAIL VARCHAR(30), 
  FONE VARCHAR(13) CONSTRAINT NN_TB_PESSOA_JURIDICA_LOG_FONE NOT NULL,
  FONE_FAX VARCHAR(13),
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_PESSOA_JURIDICA_LOG_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PESSOA_JURIDICA_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PESSOA_JURIDICA_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PESSOA_JURIDICA_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PF_ENDERECO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_PF_ENDERECO_LOG_DT_EXECUTOR NOT NULL,
  ...
  CEP NUMERIC(8,0) CONSTRAINT NN_TB_PF_ENDERECO_LOG_CEP NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PF_ENDERECO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PF_ENDERECO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PF_ENDERECO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PJ_ENDERECO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_PJ_ENDERECO_LOG_DT_EXECUTOR NOT NULL,
  ...
  CEP NUMERIC(8,0) CONSTRAINT NN_TB_PJ_ENDERECO_LOG_CEP NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PJ_ENDERECO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PJ_ENDERECO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PJ_ENDERECO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_PROFISSAO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_PROFISSAO_LOG_DT_EXECUTOR NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PROFISSAO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PROFISSAO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PROFISSAO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_RELACIONADOS_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_RELACIONADOS_LOG_DT_EXECUTOR NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_RELACIONADOS_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_RELACIONADOS_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_RELACIONADOS_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_SERVICO_ADICIONAL_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_SERVICO_ADICIONAL_LOG_DT_EXECUTOR NOT NULL,
  ...
  CD_ORDEM_SERVICO INTEGER CONSTRAINT NN_TB_SERVICO_ADICIONAL_LOG_CD_ORDEM_SERVICO NOT NULL,
  DT_INICIO DATE CONSTRAINT NN_TB_SERVICO_ADICIIONAL_LOG_DT_INICIO NOT NULL,
  DT_FIM INTEGER,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_SERVICO_ADICIONAL_LOG_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_SERVICO_ADICIONAL_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_SERVICO_ADICIONAL_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_SERVICO_ADICIONAL_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_SETOR_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_SETOR_LOG_DT_EXECUTOR NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_SETOR_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_SSETOR_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_SETOR_LOG_DT_USUARIO_ATUALIZA NOT NULL,
...
CREATE TABLE TB_USUARIO_LOG(
  ...
  DT_EXECUTOR DATE CONSTRAINT NN_TB_USUARIO_LOG_DT_EXECUTOR NOT NULL,
  COMANDO_EXECUTADO CHAR(1) CONSTRAINT NN_TB_USUARIO_LOG_COMANDO_EXECUTADO NOT NULL,
  CD_USUARIO SERIAL CONSTRAINT NN_TB_USUARIO_LOG_CD_USUARIO NOT NULL,
  CD_PESSOA_FISICA INTEGER CONSTRAINT NN_TB_USUARIO_LOG_CD_PESSOA_FISICA NOT NULL,
  LOGIN VARCHAR(20) CONSTRAINT NN_TB_USUARIO_LOG_LOGIN NOT NULL,
  SENHA VARCHAR(64) CONSTRAINT NN_TB_USUARIO_LOG_SENHA NOT NULL,
  SALT  VARCHAR(32) CONSTRAINT NN_TB_USUARIO_LOG_SALT NOT NULL,
  ...
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_USUARIO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_USUARIO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_USUARIO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
  CONSTRAINT PK_TB_USUARIO_LOG_NR_SEQ_LOG PRIMARY KEY(NR_SEQ_LOG)
);

ALTER TABLE TB_USUARIO_LOG ADD CONSTRAINT FK_TB_USUARIO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_SETOR_LOG ADD CONSTRAINT FK_TB_SETOR_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_SERVICO_ADICIONAL_LOG ADD CONSTRAINT FK_TB_SERVICO_ADICIONAL_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_RELACIONADOS_LOG ADD CONSTRAINT FK_TB_RELACIONADOS_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PROFISSAO_LOG ADD CONSTRAINT FK_TB_PROFISSAO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PREDIO_LOG ADD CONSTRAINT FK_TB_PREDIO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PJ_ENDERECO_LOG ADD CONSTRAINT FK_TB_PJ_ENDERECO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PF_ENDERECO_LOG ADD CONSTRAINT FK_TB_PF_ENDERECO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PESSOA_JURIDICA_LOG ADD CONSTRAINT FK_TB_PESSOA_JURIDICA_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PESSOA_FISICA_LOG ADD CONSTRAINT FK_TB_PESSOA_FISICA_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ORDEM_SERVICO_LOG ADD CONSTRAINT FK_TB_ORDEM_SERVICO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ORCAMENTO_LOG ADD CONSTRAINT FK_TB_ORCAMENTO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_OCORRENCIA_LOG ADD CONSTRAINT FK_TB_OCORRENCIA_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_OCORRENCIA_PF_ENVOLVIDA_LOG ADD CONSTRAINT FK_TB_OCORRENCIA_PF_ENVOLVIDA_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_MORADOR_ENDERECO_LOG ADD CONSTRAINT FK_TB_MORADOR_ENDERECO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_ITENS_ORCAMENTO_LOG ADD CONSTRAINT FK_TB_ITENS_ORCAMENTO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CONDOMINIO_LOG ADD CONSTRAINT FK_TB_CONDOMINIO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CATEGORIA_VALOR_LOG ADD CONSTRAINT FK_TB_CATEGORIA_VALOR_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_CATEGORIA_LOG ADD CONSTRAINT FK_TB_CATEGORIA_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_APARTAMENTO_LOG ADD CONSTRAINT FK_TB_APARTAMENTO_LOG_USU_EXECUTOR FOREIGN KEY(USU_EXECUTOR) REFERENCES TB_USUARIO(CD_USUARIO);
