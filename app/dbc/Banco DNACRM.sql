...
CREATE TABLE TB_USUARIO(
  ...
  SENHA VARCHAR(60) CONSTRAINT NN_TB_USUARIO_SENHA NOT NULL,
...
CREATE TABLE TB_USUARIO_LOG(
  ...
  SENHA VARCHAR(60) CONSTRAINT NN_TB_USUARIO_LOG_SENHA NOT NULL,
...
(1,
'Admin',
'$2y$10$bZITLTRemPCnqZugBcSPD.8MoCXlh6ZVrsCQ3Oo/P3dZnrBX.Kbz6',
1,
'A');
