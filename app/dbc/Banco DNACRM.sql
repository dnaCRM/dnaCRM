...
CREATE TABLE TB_APARTAMENTO(
  ...
  CD_PREDIO INTEGER CONSTRAINT NN_TB_APARTAMENTO_CD_PREDIO NOT NULL,
...
CREATE TABLE TB_PESSOA_FISICA(
  ...
  EMAIL VARCHAR(60),  
  FONE VARCHAR(13) CONSTRAINT NN_TB_PESSOA_FISICA_FONE NOT NULL,  
  CELULAR VARCHAR(14),
...
CREATE TABLE TB_PREDIO(
  CD_PREDIO SERIAL,
  CD_SETOR INTEGER CONSTRAINT NN_TB_PREDIO_CD_SETOR NOT NULL,
  DESC_PREDIO VARCHAR(10) CONSTRAINT NN_TB_PREDIO_DESC_PREDIO NOT NULL,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_PREDIO_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PREDIO_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PREDIO_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PREDIO_DT_USUARIO_ATUALIZA NOT NULL,
  CONSTRAINT PK_TB_PREDIO_CD_PREDIO PRIMARY KEY(CD_PREDIO)
);
...
CREATE TABLE TB_SERVICO_ADICIONAL(
  ...
  CD_ORDEM_SERVICO INTEGER CONSTRAINT NN_TB_SERVICO_ADICIONAL_CD_ORDEM_SERVICO NOT NULL,
...
CREATE TABLE TB_SETOR(
  ...
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_SSETOR_CD_USUARIO_ATUALIZA NOT NULL,
...
ALTER TABLE TB_PREDIO ADD CONSTRAINT FK_TB_PREDIO_CD_SETOR FOREIGN KEY(CD_SETOR) REFERENCES TB_SETOR(CD_SETOR);
...
ALTER TABLE TB_APARTAMENTO ADD CONSTRAINT FK_TB_APARTAMENTO_CD_PREDIO FOREIGN KEY(CD_PREDIO) REFERENCES TB_PREDIO(CD_PREDIO);
...
ALTER TABLE TB_PREDIO ADD CONSTRAINT FK_TB_PREDIO_CD_USUARIO_CRIACAO FOREIGN KEY(CD_USUARIO_CRIACAO) REFERENCES TB_USUARIO(CD_USUARIO);

ALTER TABLE TB_PREDIO ADD CONSTRAINT FK_TB_PREDIO_CD_USUARIO_ATUALIZA FOREIGN KEY(CD_USUARIO_ATUALIZA) REFERENCES TB_USUARIO(CD_USUARIO);
...
CREATE TABLE TB_PREDIO_LOG(
  NR_SEQ_LOG SERIAL,
  USU_EXECUTOR INTEGER CONSTRAINT NN_TB_PREDIO_LOG_USU_EXECUTOR NOT NULL,
  DT_EXECUTOR DATE CONSTRAINT NN_TB_PREDIO_LOG_DT_EXECUTOR NOT NULL,
  COMANDO_EXECUTADO CHAR(1) CONSTRAINT NN_TB_PREDIO_LOG_COMANDO_EXECUTADO NOT NULL,
  CD_PREDIO INTEGER CONSTRAINT NN_TB_PREDIO_LOG_CD_PREDIO NOT NULL,
  CD_SETOR INTEGER CONSTRAINT NN_TB_PREDIO_LOG_CD_SETOR NOT NULL,
  DESC_PREDIO VARCHAR(10) CONSTRAINT NN_TB_PREDIO_LOG_DESC_PREDIO NOT NULL,
  CD_USUARIO_CRIACAO INTEGER CONSTRAINT NN_TB_PREDIO_LOG_CD_USUARIO_CRIACAO NOT NULL,
  DT_USUARIO_CRIACAO DATE CONSTRAINT NN_TB_PREDIO_LOG_DT_USUARIO_CRIACAO NOT NULL,   
  CD_USUARIO_ATUALIZA INTEGER CONSTRAINT NN_TB_PREDIO_LOG_CD_USUARIO_ATUALIZA NOT NULL,
  DT_USUARIO_ATUALIZA DATE CONSTRAINT NN_TB_PREDIO_LOG_DT_USUARIO_ATUALIZA NOT NULL,
  CONSTRAINT PK_TB_PREDIO_LOG_NR_SEQ_LOG PRIMARY KEY(NR_SEQ_LOG)
);
