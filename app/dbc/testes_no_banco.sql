...
CREATE TABLE TB_CONDOMINIO(
  ...
  CD_VL_CATG_ESTADO INTEGER CONSTRAINT NN_TB_CONDOMINIO_CD_CATG_VL_ESTADO NOT NULL,
...
CREATE TABLE TB_INSTITUICAO_ENSINO(
 ...
 CD_VL_CATG_INSTITUICAO INTEGER CONSTRAINT NN_TB_INSTITUICAO_ENSINO_CD_CATG_VL_INSTITUICAO NOT NULL,
...
FOREIGN KEY(CD_CATG_INSTITUICAO,CD_VL_CATG_INSTITUICAO) REFERENCES TB_CATEGORIA_VALOR(CD_CATEGORIA,CD_VL_CATEGORIA);
...
CREATE TABLE TB_CONDOMINIO_LOG(
  ...
  CD_VL_CATG_ESTADO INTEGER CONSTRAINT NN_TB_CONDOMINIO_LOG_CD_CATG_VL_ESTADO NOT NULL,
...
dt_usuario_atualiza)
VALUES
('Bela Vista','00000-00','Joaquim Barbosa',311,
'Santo Espedito','São Paulo',2,52,1,now(),
1,now());
...
insert into tb_pessoa_fisica
(nm_pessoa_fisica, cd_pessoa_juridica, cd_profissao, cpf, rg, cd_catg_org_rg, cd_vl_catg_org_rg, 
email, dt_nascimento, ie_sexo, cd_usuario_criacao, dt_usuario_criacao, cd_usuario_atualiza, 
dt_usuario_atualiza, ie_estuda, cd_instituicao)
values
('Bruce Banner', 1, 1, '213.416.489-89', '111231', 1, 1, 'banner@net.com', '12/12/1987', 'f',
1, '12/02/2014', 1, '12/09/2014', 'A', 1);